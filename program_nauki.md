# Mój Program Nauki Gita i AI

### Tydzień 1: Podstawy terminala i Gita
* [x] Instalacja i konfiguracja ('git config')
* [x] Tworzenie plików w terminalu ('echo', 'nano')
* [x] Cykl: 'add' -> 'commit' -> 'push'
